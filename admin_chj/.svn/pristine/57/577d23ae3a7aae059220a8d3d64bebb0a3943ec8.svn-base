...
$_LANG['appsys_manage'] = '应用系统管理';
$_LANG['report_manage'] = '报表管理';
$_LANG['financial_manage'] = '财务管理';
$_LANG['interface_manage'] = '接口管理';
...
//应用系统管理
$_LANG['parking_sys'] = '缴停车费';
$_LANG['parking_trading'] = '停车位交易';
$_LANG['express_sys'] = '快递服务';
$_LANG['card_charging'] = '加油卡充值';
$_LANG['mobile_recharge'] = '手机充值';
$_LANG['home_laundry'] = '上门洗衣';
$_LANG['benztime_rent'] = '奔驰时租';
$_LANG['commuter_bus'] = '通勤巴士';
$_LANG['key_system'] = '车钥匙';
$_LANG['living_payment'] = '生活缴费';

//应用系统管理
$_LANG['report_stats'] = '报表管理';

//应用系统管理
$_LANG['financial_stats'] = '财务管理';

//应用系统管理
$_LANG['interface_stats'] = '接口管理';
?>