...
$_LANG['use_help'] = '使用说明：' .
        '<ol>' .
          '<li>上传文件应为TXT文件<br />' .
              'TXT文件第一列为卡片序号；第二列为开始日期；第三列为使用截至日期；第四列机构号、第五列为产品号。<br />'.
              '(用记事本创建TXT文件方法：在TXT中按卡号、开始日期、截至日期、机构号、产品号的顺序填写数据，完成后直接保存为 .txt 文件即可)'.
          '<li>开始日期和截至日期格式为2006-11-6或2006/11/6'.
          '<li>卡号、开始日期、截至日期、机构号、产品号中不要使用中文</li>' .
        '</ol>';
