...
$modules['04_order']['01_cardorder_list']           = 'order.php?act=cardlist';
...
$modules['10_priv_admin']['organize_list']			= 'organize.php?act=list';
...
$modules['17_appsys_manage']['02_parking_sys']        = 'appsys_manage.php?act=parking';
$modules['17_appsys_manage']['04_express_sys']        = 'appsys_manage.php?act=express';
$modules['17_appsys_manage']['03_parking_trading']        = 'appsys_manage.php?act=trading';
$modules['17_appsys_manage']['05_gas_card_charging']      = 'appsys_manage.php?act=gascard';
$modules['17_appsys_manage']['11_living_payment']        = 'appsys_manage.php?act=living';
$modules['17_appsys_manage']['06_mobile_recharge']        = 'appsys_manage.php?act=mobile';
$modules['17_appsys_manage']['07_home_laundry']        = 'appsys_manage.php?act=laundry';
$modules['17_appsys_manage']['08_benztime_rent']        = 'appsys_manage.php?act=rent';
$modules['17_appsys_manage']['09_commuter_bus']        = 'appsys_manage.php?act=bus';
$modules['17_appsys_manage']['10_car_key_system']        = 'appsys_manage.php?act=carkey';

$modules['18_report_manage']['02_report_stats']	=	'report_manage.php?act=report';

$modules['19_financial_manage']['02_financial_stats']	=	'financial_manage.php?act=financial';
