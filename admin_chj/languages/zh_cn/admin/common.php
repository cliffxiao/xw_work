 ...
 * 网站地址: http://www.云平台.com；
 * $Id: common.php 17217 
*/

$_LANG['app_name'] = '云平台';
$_LANG['cp_home'] = '云平台 管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2016-2017 中国支付通集团，并保留所有权利。';
...
$_LANG['17_appsys_manage'] = '应用系统管理';
	$_LANG['02_parking_sys'] = '缴停车费';
	$_LANG['03_parking_trading'] = '停车位交易';
	$_LANG['04_express_sys'] = '快递服务';
	$_LANG['05_gas_card_charging'] = '加油卡充值';
	$_LANG['06_mobile_recharge'] = '手机充值';
	$_LANG['07_home_laundry'] = '上门洗衣';
	$_LANG['08_benztime_rent'] = '奔驰时租';
	$_LANG['09_commuter_bus'] = '通勤巴士';
	$_LANG['10_car_key_system'] = '车钥匙';
	$_LANG['11_living_payment'] = '生活缴费';

$_LANG['18_report_manage'] = '报表管理';
	$_LANG['02_report_stats'] = '报表管理';

$_LANG['19_financial_manage'] = '财务管理';
	$_LANG['02_financial_stats'] = '财务管理';

$_LANG['20_interface_manage'] = '接口管理';
	$_LANG['02_interface_stats'] = '接口管理';	
	
/*
$_LANG['18_appsys_manage'] = '优惠券管理';
$_LANG['19_appsys_manage'] = '报表管理';
$_LANG['20_appsys_manage'] = '财务管理';
$_LANG['22_appsys_manage'] = '接口管理';
$_LANG['23_appsys_manage'] = '意见反馈管理';
$_LANG['24_appsys_manage'] = '物业缴费管理';
$_LANG['25_appsys_manage'] = '电费管理';
$_LANG['26_appsys_manage'] = '物业报修管理';
$_LANG['27_appsys_manage'] = '商品管理';
$_LANG['28_appsys_manage'] = '商品管理';
$_LANG['29_appsys_manage'] = '信息管理';*/
...
/* 订单管理 */
$_LANG['01_cardorder_list'] = '卡卷订单';
$_LANG['02_cardorder_list_info'] = '卡卷订单信息';
...
/* 应用系统管理 */
$_LANG['parking_sys'] = '缴费停车系统';
$_LANG['express_sys'] = '快递服务系统';
$_LANG['parking_trading'] = '停车位交易系统';
$_LANG['gas_card_charging'] = '加油卡充值系统';
$_LANG['living_payment'] = '生活缴费系统';
$_LANG['mobile_recharge'] = '手机充值系统';
$_LANG['home_laundry'] = '上门洗衣系统';
$_LANG['benztime_rent'] = '奔驰时租系统';
$_LANG['commuter_bus'] = '通勤巴士系统';
$_LANG['car_key_system'] = '车钥匙系统';
