...
var Validator = function(name)
{
  ...
  * @param :  required    是否必须
  */
  this.maxLength = function(controlId, msg, required)
  {
    var obj = document.forms[this.formName].elements[controlId];
    ...
    {
      this.addErrorMsg(msg.replace(/\{0\}/g, maxlength));
    }
  }
  ...
  * @param :  required    是否必须
  */
  this.minLength = function(controlId, msg, required)
  {
    var obj = document.forms[this.formName].elements[controlId];
    ...
    {
      this.addErrorMsg(msg.replace(/\{0\}/g, minlength));
    }
  }
  ...
  */
  ...
  {
    var objects = document.forms[this.formName].elements;
    var checked = false;
