...
//权限管理
    ...
    $purview['organize_list']       = 'organize_manage';
...
//订单管理权限
	$purview['01_cardorder_list']    = 'card_list';
...
//应用系统管理
    $purview['02_parking_sys']      = 'parking_sys';
    $purview['03_parking_trading']  = 'parking_trading';
    $purview['04_express_sys']      = 'express_sys';
    $purview['05_gas_card_charging']= 'card_charging';
    $purview['06_mobile_recharge']  = 'mobile_recharge';
    $purview['07_home_laundry']     = 'home_laundry';
    $purview['08_benztime_rent']    = 'benztime_rent';
    $purview['09_commuter_bus']     = 'commuter_bus';
    $purview['10_car_key_system']   = 'key_system';
    $purview['11_living_payment']   = 'living_payment';

//报表管理
    $purview['02_report_stats']     = 'report_stats';

//财务管理
    $purview['02_financial_stats']  = 'financial_stats';

//接口管理
    $purview['02_interface_stats']  = 'interface_stats';
?>