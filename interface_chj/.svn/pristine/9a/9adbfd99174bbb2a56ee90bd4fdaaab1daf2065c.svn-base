...
$_LANG['edit_password_failure'] = '您输入的密码不正确！';
...
$_LANG['msg_mobile_not_exists'] = '手机号不存在';
$_LANG['next'] = '下一步';
...
$_LANG['passport_js']['username_length'] = '- 用户名长度在 3 到 15 个字符之间。';
...
$_LANG['passport_js']['password_length'] = '- 登录密码长度在 6 到 20 个字符之间。';
$_LANG['passport_js']['password_rule'] = '- 登录密码不符合规则，大小写字母、数字、符号（!@#$%^&*）。';
$_LANG['passport_js']['password_error_count'] = '- 密码输错 5 次。';
...
$_LANG['edit_gesture'] = '修改手势密码成功！';
$_LANG['add_gesture'] = '添加手势密码成功！';
$_LANG['close_gesture'] = '关闭手势密码成功！';
...
$_LANG['username_not_exist'] = '用户不存在';


/*支付密码*/
$_LANG['pay_password_success'] = '支付密码正确。';
$_LANG['pay_password_error'] = '支付密码不正确。';
$_LANG['update_pay_password'] = '更新支付密码成功。';

/*真实信息*/
$_LANG['true_name_emtpy'] = '姓名不能为空。';
$_LANG['user_idcard_emtpy'] = '身份证号不能为空。';
$_LANG['user_info_error'] = '用户真实信息不正确。';
?>