...
class CommonController extends BaseController
{
    ...
    protected function ecshop_init()
    {
        ...
        if (! empty($stylename)) {
            $this->assign('couponbole_css_path', __ROOT__ . '/themes/' . C('template') . '/css/couponbole' . C('stylename') . '.css');
        } else {
            $this->assign('couponbole_css_path', __ROOT__ . '/themes/' . C('template') . '/css/couponbole.css');
        }
    }
}
