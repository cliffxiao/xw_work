...
function date_from_format($format=null, $date=null)
{
    $arr = date_parse_from_format($format, $date);
    $arr['hour'] = is_numeric($arr['hour']) ? $arr['hour'] : 23;
    $arr['minute'] = is_numeric($arr['minute']) ? $arr['minute'] : 59;
    $arr['second'] = is_numeric($arr['second']) ? $arr['second'] : 59;
